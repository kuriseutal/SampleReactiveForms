...
export const KOREANSONGS: Song[] = [
  {
    id: 1,
    isFavorited: false,
    isLyricsShown: false,
    img: "https://images-na.ssl-images-amazon.com/images/I/51hOR5qMIJL._SY355_.jpg",
    title: "너였다면 (If It Is You)",
    artist: "정승환 (Jung Seung Hwan)",
    album: "Another Oh Hae Young OST",
    date: "2016",
    //#region lyrics
    lyrics: `
    왜 너에겐 그렇게 어려운지
    ...
    //#endregion
    chords: "v",
    tags: ["ost", "2016", "oh hae young", "jung seung hwan"]
  },
  {
    id: 2,
    isFavorited: true,
    isLyricsShown: false,
    img: "https://i.pinimg.com/originals/2d/81/04/2d81041554090a8bd1edbe15ea67b6dd.jpg",
    title: "나쁜 마음을 먹게해 (Fight the Bad Feeling)",
    artist: "T-MAX (티맥스)",
